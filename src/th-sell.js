...
import {
  ...
  createFlowUIHelpers,
} from './modules/flows/THSellFlows'
...
import personalizationData from './data/th-sell-personalization-data.json'
...
function initExperiments() {
  ...
  if (includeSellFilloutFormsExperiment) {
    ...
    // 100%: sell-fillout-form-1
    // const randomValue = Math.random()

    let variation = 'sell-fillout-form-1' // Default variation
    // if (randomValue < 0.5) {
    //   variation = 'sell-fillout-form-2'
    // }
    ...
    $trackingService.track('2025-10 Sell Launch Fillout Forms Experiment Set')
  }
}
